...
int c = sc.nextInt () ;
System.out.println (" Enter Product Uni t Pr i c e : " ) ;
int d = sc.nextInt () ;
...
for(int i=0;i<n;i++){
    ...
    System.out.println("---------------------------");
    System.out.printf("%5s %20s %25s %10s %10s","Prod Id","Name","Quantity","Unit Price","Total");
    System.out.println();
    System.out.println("-----------------------------------------------");
